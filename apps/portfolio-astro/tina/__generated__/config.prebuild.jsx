...
var branch = process.env.TINA_BRANCH || process.env.VERCEL_GIT_COMMIT_REF || process.env.VERCEL_BRANCH || "main";
    ...
    collections: [
      {
        ...
        fields: [
          { name: "title", label: "Title", type: "string", isTitle: true, required: true },
          {
            ...
            required: true,
            ui: {
              validate: (value) => value && /^[a-z0-9-]+$/.test(value) ? void 0 : "Use lowercase kebab-case (letters, numbers, hyphen only)"
            }
          },
          {
            name: "summary",
            ...
            ui: {
              component: "textarea",
              validate: (value) => value && value.length <= 220 ? void 0 : "Keep summary under 220 characters"
            }
          },
            ...
            fields: [
              {
                ...
                fields: [
                  { name: "asset", label: "Asset", type: "image", required: true },
                  {
                    ...
                    required: true,
                    ui: {
                      validate: (value) => value && value.trim().length > 0 ? void 0 : "Provide meaningful alt text"
                    }
                  },
          ...
          },
          {
            ...
            fields: [
              ...
              },
              {
                ...
                required: false,
                ui: {
                  validate: (value) => value === void 0 || value >= 0 && value <= 2 ? void 0 : "Motion delay must be between 0 and 2 seconds"
                }
              }
            ]
          },
      ...
      },
      {
        ...
        fields: [
          ...
          { name: "location", label: "Location", type: "string", required: true },
          {
            ...
            ui: {
              component: "textarea",
              validate: (value) => value && value.length <= 280 ? void 0 : "Keep intro under 280 characters"
            }
          },
          {
            name: "bioSnippet",
          ...
          },
          {
            ...
            required: true,
            ui: {
              validate: (value) => value && /.+@.+\..+/.test(value) ? void 0 : "Provide a valid email address"
            }
          },
          {
      ...
      },
      {
        ...
        fields: [
          ...
          { name: "location", label: "Location", type: "string", required: true },
          {
            ...
            ui: {
              component: "textarea",
              validate: (value) => value && value.length <= 320 ? void 0 : "Keep lead under 320 characters"
            }
          },
          {
            name: "narrativeTone",
          ...
          },
          {
            ...
            fields: [
              { name: "category", label: "Category", type: "string", required: true },
              {
                ...
                required: true,
                ui: {
                  validate: (value) => Array.isArray(value) && value.length > 0 ? void 0 : "Provide at least one skill per category"
                }
              }
            ]
          },
